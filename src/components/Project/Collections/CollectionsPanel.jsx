      ...
      project.collections.length > 0 ? 
        <div className="gallery-list">
          ...
          {project.collections.map((collection) => (
            ...
            : <Link  key={collection.id} className={`gallery ${collectionId===collection.id && 'active'} ${collection.status !== 'visible' ? '' : ''}`} to={`/${defaultStudio.domain}/gallery/${project.id}/${collection.id}`}>
                <div className="thumbnails">
                  <div className="thumbnail thumb1">
